        ...
        <div className="flex justify-center items-center min-h-screen">
          ...
          >
            <h2 className="text-2xl font-bold text-center mb-6">
              <u>Add New Mobile Phone</u>
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex flex-col">
                <label htmlFor="brandName" className="text-sm font-medium mb-1">
                  Brand Name
                </label>
                <input
                  type="text"
              ...
              <div className="flex flex-col">
                <label htmlFor="modelName" className="text-sm font-medium mb-1">
                  Model Name
                </label>
                <input
                  type="text"
              ...
              <div className="flex flex-col">
                <label htmlFor="fileInput" className="text-sm font-medium mb-1">
                  Image
                </label>
                <input
                  type="file"
              ...
              <div className="flex flex-col">
                <label htmlFor="productQuantity" className="text-sm font-medium mb-1">
                  Quantity
                </label>
                <input
                  type="number"
