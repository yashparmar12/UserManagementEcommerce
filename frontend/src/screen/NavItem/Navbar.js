...
const Navbar = () => {
  ...
  return (
    ...
    //       </div>
    //     </div>
    //   </header>:<header className="flex shadow-md py-4 px-4 sm:px-10 bg-white font-[sans-serif] min-h-[70px] tracking-wide relative z-50">
    //     <div className="flex flex-wrap items-center justify-between gap-5 w-full">
    //       <div
    //         id="collapseMenu"
    //         className="max-lg:hidden lg:!block max-lg:before:fixed max-lg:before:bg-black max-lg:before:opacity-50 max-lg:before:inset-0 max-lg:before:z-50"
  ...
  {userinfo.role === "user" ? (
    <header className="flex shadow-md py-4 px-4 sm:px-10 bg-white font-[sans-serif] min-h-[70px] tracking-wide relative z-50">
      <div className="flex flex-wrap items-center justify-between gap-5 w-full">
        <div
          id="collapseMenu"
          className="lg:block hidden before:fixed before:bg-black before:opacity-50 before:inset-0 before:z-50"
        >
          <ul className="lg:flex gap-x-5 fixed lg:relative bg-white w-1/2 lg:w-auto min-w-[300px] top-0 left-0 p-6 h-full lg:h-auto shadow-md overflow-auto z-50">
            <li className="border-b border-gray-300 py-3 px-3 mr-10">
              <NavLink
                to="/userHome"
                className={({ isActive }) =>
                  isActive
